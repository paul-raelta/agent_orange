  ...
  return (
    <div className="screen">
      ...
      <div className="tl-mobile">
        {lanes.map((ln) => (
          <div className="tla-card" key={ln.ticker} onClick={() => onOpen(ln.ticker)}>
            ...
            <div className="tla-events">
              {ln.bars.map((b, i) => (
                <div className={"tla-ev tla-" + b.type} key={i}>
                  ...
                  <span className="tla-ev-type">{b.type === "reported" ? "REPORTED" : b.type === "watching" ? "WATCHING" : "PREDICTED"}</span>
        ...
        <p className="tla-foot">Reported events recorded · predicted windows from each company’s historical cadence.</p>
      </div>
    </div>
  );
}
